...
The implementation specification and working domain flows are in `hublet_spec.md`. No logo,
photography, testimonials or other brand assets exist and none should be fabricated.
